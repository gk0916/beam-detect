...
class MvCamera():
    ...
    # # user: gk
    # def IMV_DisplayOneFrame(self, pstRecordParam):
    #     return MVSDKdll.IMV_DisplayOneFrame(self.handle,pstRecordParam)
    
    # user: gk
    def IMV_OpenRecord(self, pstRecordParam):
        return MVSDKdll.IMV_OpenRecord(self.handle,pstRecordParam)
    ...
    def IMV_InputOneFrame(self, pstRecordFrameInfoParam):
        return MVSDKdll.IMV_InputOneFrame(self.handle,pstRecordFrameInfoParam)
